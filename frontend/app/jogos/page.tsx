    ...
    <main className="flex-1 px-4 py-10 sm:py-16">
      <div className="mx-auto max-w-3xl">
        ...
        <section className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <Link
            href="/jogos/engenharia-social"
            className="group animate-fade-in-up flex flex-col rounded-3xl border border-slate-200/60 bg-white/80 p-6 shadow-xl shadow-teal-100/50 backdrop-blur-sm transition hover:-translate-y-0.5 hover:shadow-2xl hover:shadow-teal-200 focus:outline-none focus-visible:ring-4 focus-visible:ring-teal-200"
            style={{ animationDelay: "0.5s" }}
          >
            <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-teal-500 to-cyan-600 shadow-md shadow-teal-200">
              <Brain className="h-6 w-6 text-white" strokeWidth={2.5} aria-hidden="true" />
            </div>
            <h2 className="text-xl font-semibold text-slate-900">
              Detetive da Engenharia Social
            </h2>
            <p className="mt-2 flex-1 text-sm leading-relaxed text-slate-600">
              Leia 6 cenários do cotidiano e identifique a tática de manipulação
              psicológica usada — pretexting, urgência falsa, autoridade falsa e mais.
            </p>
            <div className="mt-5 flex items-center justify-between">
              <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-100 px-2.5 py-1 text-xs font-semibold text-emerald-700">
                <Sparkles className="h-3 w-3" aria-hidden="true" />
