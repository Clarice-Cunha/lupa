...
O site é protegido por senha (frontend/middleware.ts). Em vez de mexer no
middleware — alteração que é fácil esquecer de desfazer —, o servidor sobe com
uma senha temporária e o navegador recebe o cookie correspondente.
...
SENHA = "acesso-temporario-de-script"
...
COOKIE_ACESSO = [{"name": "lupa_acesso", "value": SENHA, "url": ENDERECO}]
...
def servidor_local():
    ...
    processo = subprocess.Popen(
        ...
        cwd=str(FRONTEND),
        env={**os.environ, "ACESSO_SENHA": SENHA},
